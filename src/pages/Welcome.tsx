...
const Welcome = () => {
  ...
  // If coming from an invite link, redirect to accept-invite
        ...
        <div className="w-full max-w-sm space-y-8">
          {showLogin ? (
            ...
            <>
              ...
              <button
                onClick={() => { setShowLogin(false); setSent(false); setEmail(""); setError(""); }}
                className="block mx-auto label-meta text-muted-foreground underline underline-offset-4 hover:text-foreground transition-colors"
              >
                Back
              </button>
            </>
            ...
            <>
              ...
              <div className="space-y-6 text-center">
                <p className="font-display text-lg italic text-foreground/80 leading-relaxed">
                  A private circle for the women who built it.
                </p>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Sonder Circle is invite-only. If you've received an invite, check your email for the link.
                  If you'd like to be considered, ask the woman who told you about us to send an invitation.
                </p>
              </div>
