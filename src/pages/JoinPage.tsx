...
const JoinPage = () => {
  ...
  // Dev login (password-based, hidden behind triple-tap on footer)
  ...
  if (view === "sent") {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-background px-8 text-center" style={{ minHeight: "100svh" }}>
        <h1 className="font-serif text-[28px] text-espresso mb-3">Check your inbox</h1>
        <p className="font-sans text-[13px] text-taupe leading-relaxed max-w-[260px]">
          We sent a sign-in link to{" "}
          <span className="text-espresso font-medium">{email}</span>.
          Tap the link in your email to continue.
        </p>
        <button
          onClick={() => { setView("landing"); setEmail(""); setError(""); }}
          className="mt-8 font-sans text-[11px] text-taupe underline underline-offset-2"
        >
